/* This file defines the inode-layer functions for fetching inodes
 * from disk, getting a file's size, and getting the block number
...
/**
 * Given an inode, this function computes the size of its file (in bytes)
 * from the size0 and size1 fields in the inode.
 */
